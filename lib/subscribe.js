...
var sendgrid = require('sendgrid')(config.sendgrid.username, config.sendgrid.key);
...
function createJoinedPromise(promise, callback) {
    //todo?      
}
...
Subscription.prototype.send = function (params) {
    ...
    var email = {
        ...
        text: this.spot.forecast.toString()
    };
